...
export const getStyles = (isOpen: boolean) => ({
  ...
  optionsWrapper: cn(
    'absolute p-2 right-[8px] top-[8px] flex flex-col w-[160px] rounded-[8px] bg-white shadow-dashboard scale-50 transition-all duration-300 ease-in-out opacity-0 z-10 pointer-events-none',
