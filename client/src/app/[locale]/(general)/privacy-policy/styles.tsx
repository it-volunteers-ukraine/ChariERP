export const getStyles = () => ({
  title:
    'mb-[40px] font-scada text-[26px] font-bold uppercase leading-8 tablet:text-[28px] tablet:leading-[34px] desktop:text-[32px] desktop:leading-[38px]',
  text:
    'last:mb-0 mb-8 text-left font-normal text-comet text-[16px] leading-[18px] ' +
    'tablet:text-[20px] tablet:leading-[24px] ' +
    'desktop:text-[24px] desktop:leading-[28px] ',
  subTitle:
    'mb-2 text-left font-scada text-comet uppercase font-bold text-[18px] leading-[22px] ' +
