    ...
    <div className="tablet:w-[49%] desktop:w-auto">
      <div className="flex gap-2">
        <div className="relative">
          ...
          <div className="absolute right-[22px] top-[28px] laptop:right-7 laptop:top-9">
            <IconSVG className="pointer-events-none select-none laptop:scale-[120%]" />
          </div>
        </div>
        <div>
          <h3 className="pointer-events-none pb-4 pt-2 font-scada text-[18px] font-bold uppercase first-line:select-none laptop:text-2xl">
            {title}
          </h3>
          ...
          <Link
            href={finalLink}
            target="_blank"
            className="easy-in-out font-scada text-[14px] font-[400] uppercase leading-[17px] text-[#1D1B20] underline transition-all duration-300 hover:text-[#2C73AC] laptop:text-[18px]"
          >
            {link}
          </Link>
        </div>
