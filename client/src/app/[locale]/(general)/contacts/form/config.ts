...
export const emailData = (values: IEmailData) => ({
  ...
  html: `
    ...
    <table>
      ...
      <tr><td style="padding: 8px; border: 1px solid #000;">Прізвище:</td><td style="  border: 1px solid #000; padding-left: 8px; padding-right: 8px">${values.surname}</td></tr>
