  ...
  return (
    <div className="bg-bgAuthGradient">
      <div className="container-chari pb-8 pt-10 tablet:pb-12 [&>*]:text-lightBlue">
        <div className="m-auto mb-12 flex px-2 tablet:mb-16 tablet:px-4 laptop:mb-20 laptop:max-w-[1168px] laptop:p-0 xl:max-w-[1440px] desktop:mb-[72px] desktopXl:mb-[88px]">
          <Image
            src={BannerContacts}
            alt="bannerContacts"
        ...
        <div className="mb-24 flex flex-col tablet:mb-[120px] laptop:mb-[168px] xl:max-w-[1440px] desktop:mb-[216px] desktop:flex-row desktop:justify-between desktopXl:m-auto desktopXl:mb-[288px]">
          <div className="tablet:px-4 desktop:mt-9 desktop:px-0">
            ...
            <div className="mb-16 flex flex-col justify-between gap-8 tablet:mb-20 tablet:flex-row tablet:flex-wrap tablet:gap-x-1 tablet:gap-y-6 laptop:mb-24 laptop:gap-y-12 desktop:mb-0 desktop:flex-col desktop:gap-y-8 [&>:nth-child(3)>div>div>div]:right-[25px] laptop:[&>:nth-child(3)>div>div>div]:right-8">
