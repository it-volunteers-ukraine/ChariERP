    ...
    >
      {() => (
        <Form className="w-full">
          <Title className="mb-8 mx-auto w-fit text-[26px]" title={registration('title.basicInformation')} />
          ...
          <Title className="mt-16 mb-8 mx-auto w-fit text-[26px]" title={registration('title.contactInformation')} />
                ...
                <InputField
                  ...
                  info={
                    <div>
                      ...
                      <span className={`${styles.spanStyles}`}>{registration('socialNetworks.infoItalic')}</span>
                    </div>
                  }
                />
              );
